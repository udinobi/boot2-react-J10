...
import com.wlc.boot2vue.document.SuggestedLocation;

import com.wlc.boot2vue.repository.LocationRepository;
...
public class GeoController {
    ...
    List<SuggestedLocation> suggest(
        ...
        int _maxSuggestions = Optional
            .ofNullable(maxSuggestions)
            .orElse(defaultMaxSuggestions);

        return locationRepository
            .suggestByLocation(countryCode.toUpperCase(), locationTerm, _maxSuggestions)
